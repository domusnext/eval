...
/**
 * 默认的 environment 和 headers 配置
 * 这个配置会被嵌入到代码中，可以在 Cloudflare 等无文件系统的环境中使用
 */
export const defaultConfig: {
    ...
    environment: {
        family_info: {
            ...
            roles: [
                ...
                },
                {
                    ...
                    role_name: " Amy Carter(Grandchildren/Great-Grandchildren)",
                    user_id: null,
                    role_nickname: "Amy",
                    birthday: "2025-09-23T00:00:00Z"
                },
                ...
                },
                {
                    ...
                    role_name: "Bella (Great-Grandparent)",
                    user_id: null,
                    role_nickname: "Bella",
                    birthday: "2025-09-23T00:00:00Z"
                },
                ...
                },
                {
                    ...
                    role_name: "Heisenberg (Grandparent)",
                    user_id: "a7a2dfb9-0995-489a-929e-88be06e1bf2f",
                    role_nickname: "Heisenberg",
        ...
        user_brief: {
            ...
            shopping: {
                shopping_lists: [
                    {
                        shopping_list_id: "53bdb6ac-41f7-41c0-b4c9-302202af1969",
                        name: "Default",
                        is_default: true
                    },
                    {
                        shopping_list_id: "73888623-8dfd-40d7-bacf-2be587c45f9e",
                        name: "Costco",
                        is_default: false
                    },
                    {
                        shopping_list_id: "179ceb33-2492-42e6-bb97-8b50a012189e",
                        name: "Party Supplies",
                        is_default: false
                    },
                    {
                        shopping_list_id: "5ce5e413-3258-439d-976a-926a783a56a5",
                        name: "Italian",
                        is_default: false
                    },
                    {
                        shopping_list_id: "5f141401-bce6-4ff6-9e3c-790a0b02a523",
                        name: "BBQ",
                        is_default: false
                    },
                    {
                        shopping_list_id: "9eccf857-7cc3-4950-bcac-e8bc0cf860bf",
                        name: "Groceries",
                        is_default: false
                    }
                ]
    ...
    headers: {
        "X-Family-ID": "09a097f6-d708-49e4-8ccf-a78cab898ba0",
        "X-Timezone": "Asia/Shanghai",
        "X-User-ID": "a7a2dfb9-0995-489a-929e-88be06e1bf2f",
        "TraceId": "dsafsdfasdf"
    }
};
